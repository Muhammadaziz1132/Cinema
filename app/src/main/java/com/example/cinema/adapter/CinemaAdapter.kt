...
class CinemaAdapter(
    ...
    interface OnMyItemClickListener {
        ...
        fun <Contact> onMyItemLongCLick(contact: Contact)
    }

}

open class OnMyItemClickListener {

    open fun onMyItemClckDelete(cinema: Cinema, position: Int) {}
    open fun onMyItemClckDEdit(cinema: Cinema, position: Int) {}
    open fun onMyLinClick(cinema: Cinema, position: Int) {}
}
