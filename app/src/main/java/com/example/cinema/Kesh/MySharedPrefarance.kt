package com.example.cinema.kesh
...
object MySharedPrefarance {
    ...
    var obektString: ArrayList<Cinema>
    ...
    fun arrayToGsonString(arrayList: ArrayList<Cinema>): String {
        return Gson().toJson(arrayList)
    }

    fun gsonStringToArray(gsonString: String): ArrayList<Cinema> {
